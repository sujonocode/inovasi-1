                        ...
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            ...
                            <div class="col-md-9">
                                <textarea id="catatan" name="catatan" class="form-control" rows="3"
                                    required><?= $kendala['catatan'] ?></textarea>
                            </div>
                        </div>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="url" class="col-md-3 form-label">Link: <a href="#" onclick="handleLinkClick('<?= $kendala['url'] ?>'); return false;"><i class="fa-solid fa-eye" title="Lihat"></i></a></label>
                            <div class="col-md-9">
