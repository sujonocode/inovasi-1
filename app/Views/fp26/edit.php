    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-section">
                <h2 class="text-center mb-4">Formulir Edit Data FP</h2>
                <?php if (isset($fp)): ?>
                    <form id="editForm" onsubmit="return validateCheckboxes()" action="<?= base_url('fp26/update/' . $fp['id']) ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="nomor" class="col-md-3 form-label">Nomor</label>
                            <div class="col-md-9">
                                <input id="tanggal" type="text" name="nomor" class="form-control" value="<?= $fp['nomor'] ?>" required disabled>
                            </div>
                        </div>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="tanggal" class="col-md-3 form-label">Tanggal</label>
                            <div class="col-md-9">
                                <input id="tanggal" type="date" name="tanggal" class="form-control" value="<?= $fp['tanggal'] ?>" required disabled>
                            </div>
                        </div>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                        ...
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="tanggal" class="col-md-3 form-label">Tanggal</label>
                            <div class="col-md-9">
                                <input id="tanggal" type="date" name="tanggal" class="form-control" value="<?= $fp['tanggal'] ?>" required>
                            </div>
                        </div>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="ringkasan" class="col-md-3 form-label">Ringkasan:</label>
                            <div class="col-md-9">
                                <input id="ringkasan" type="text" name="ringkasan" class="form-control"
                                    value="<?= $fp['ringkasan'] ?>" required>
                            </div>
                        </div>
                        <div class="row form-group align-items-center flex-column flex-md-row">
                            ...
                            <div class="col-md-9">
                                <textarea id="catatan" name="catatan" class="form-control" rows="3"
                                    required><?= $fp['catatan'] ?></textarea>
                            </div>
                        </div>
                        <!-- <div class="row form-group align-items-center flex-column flex-md-row">
                            <label for="url" class="col-md-3 form-label">Link: <a href="#" onclick="handleLinkClick('< ?= $fp['url'] ?>'); return false;"><i class="fa-solid fa-eye" title="Lihat"></i></a></label>
                            <div class="col-md-9">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="<?= base_url('fp26/manage') ?>" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#kode_klasifikasi').change(function() {
            ...
            if (kodeKlasifikasi) {
                $.ajax({
                    url: '<?= base_url('/fp26/create/getKodeArsip') ?>',
                    method: 'POST',
                    data: {
