    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-section">
                <h2 class="text-center mb-4">Formulir Data FP</h2>
                <form id="createForm" action="/fp26/store" method="post">
                    ...
                    <div class="row form-group align-items-center flex-column flex-md-row">
                        <label for="ringkasan" class="col-md-3 form-label">Perihal:</label>
                        <div class="col-md-9">
