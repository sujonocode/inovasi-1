                            ...
                            <?php foreach ($surats as $surat): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/surat_keluar26/edit/<?= $surat['id'] ?>"><i class="fa-solid fa-pen-to-square" title="Edit"></i></a>
...
<script>
    ...
    function openDeleteModal(suratId) {
        ...
        const deleteUrl = "<?= base_url() ?>" + "surat_keluar26/delete/" + suratId;
