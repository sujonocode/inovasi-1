...
use App\Models\JadwalQualityGatesModel;
...
class QualityGates extends BaseController
{
    protected $db;
    ...
    public function index(string $page = 'Reminder | Quality Gates')
    {
        $model = new JadwalQualityGatesModel();

        $data['title'] = ucfirst($page);
        $data['jadwalQualityGatess'] = $model->findAll();
        ...
        return view('templates/header', $data)
            . view('quality_gates/index', $data)
            . view('templates/footer');
    }

    public function manage(string $page = 'Quality Gates | Manage')
    {
        $model = new JadwalQualityGatesModel();
        ...
        return view('templates/header', $data)
            . view('quality_gates/manage', $data)
            . view('templates/footer');
    }

    public function create(string $page = 'Quality Gates | Create')
    {
        $data['title'] = ucfirst($page);
        ...
        return view('templates/header', $data)
            . view('quality_gates/create', $data)
            . view('templates/footer');
    }
    ...
    public function store()
    {
        ...
        if ($model->save($data)) {
            ...
            return redirect()->to(base_url('/quality_gates/manage'))->with('success', 'Reminder berhasil dibuat');
        }
    ...
    public function update($id)
    {
        ...
        if ($updateSuccessful) {
            ...
            return redirect()->to(base_url('quality_gates/manage'))->with('success', 'Data reminder berhasil diupdate');
        } else {
            return redirect()->to(base_url('quality_gates/manage'))->with('error', 'Gagal mengupdate data reminder');
        }
    }
    ...
    public function edit($id, string $page = 'Quality Gates | Edit')
    {
        $model = new JadwalQualityGatesModel();
        ...
        if (!$jadwalKonten) {
            ...
            return redirect()->to(base_url('quality_gates/manage'));
        }
    ...
    public function delete($id)
    {
        ...
        if (!$jadwalKonten) {
            return redirect()->to(base_url('quality_gates/manage'))->with('error', 'Jadwal tidak ditemukan');
        }
        ...
        if (session()->get('role') === 'admin') {
            ...
            return redirect()->to(base_url('quality_gates/manage'))->with('success', 'Data reminder berhasil dihapus');
        } else {
        ...
        if ($deleteSuccessful) {
            ...
            return redirect()->to(base_url('quality_gates/manage'))->with('error', 'Gagal menghapus data reminder');
        }
    }
    ...
    public function getEvents()
    {
        ...
        $jadwalQualityGatess = $model->findAll();

        return view('templates/header')
            . view('quality_gates/index', ['jadwalQualityGatess' => $jadwalQualityGatess])
            . view('templates/footer');
    }

    public function maintenance(string $page = 'Quality Gates | Maintenance')
    {
        $data['title'] = ucfirst($page);
