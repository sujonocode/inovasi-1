...
use App\Models\JadwalLainnyaModel;
...
class Lainnya extends BaseController
{
    ...
    public function index(string $page = 'Reminder | Lainnya')
    {
        $model = new JadwalLainnyaModel();

        $data['title'] = ucfirst($page);
        $data['jadwalLainnyas'] = $model->findAll();
        ...
        return view('templates/header', $data)
            . view('lainnya/index', $data)
            . view('templates/footer');
    }

    public function manage(string $page = 'Lainnya | Manage')
    {
        $model = new JadwalLainnyaModel();
        ...
        return view('templates/header', $data)
            . view('lainnya/manage', $data)
            . view('templates/footer');
    }

    public function create(string $page = 'Lainnya | Create')
    {
        $data['title'] = ucfirst($page);
    ...
    public function store()
    {
        ...
        if ($model->save($data)) {
            ...
            return redirect()->to(base_url('/lainnya/manage'))->with('success', 'Reminder berhasil dibuat');
        }
    ...
    public function update($id)
    {
        ...
        if ($updateSuccessful) {
            ...
            return redirect()->to(base_url('lainnya/manage'))->with('success', 'Data reminder berhasil diupdate');
        } else {
            return redirect()->to(base_url('lainnya/manage'))->with('error', 'Gagal mengupdate data reminder');
        }
    }
    ...
    public function edit($id, string $page = 'Lainnya | Edit')
    {
        $model = new JadwalLainnyaModel();
        ...
        if (!$jadwalKonten) {
            ...
            return redirect()->to(base_url('lainnya/manage'));
        }
    ...
    public function delete($id)
    {
        ...
        if (!$jadwalKonten) {
            return redirect()->to(base_url('lainnya/manage'))->with('error', 'Jadwal tidak ditemukan');
        }
        ...
        if (session()->get('role') === 'admin') {
            ...
            return redirect()->to(base_url('lainnya/manage'))->with('success', 'Data reminder berhasil dihapus');
        } else {
        ...
        if ($deleteSuccessful) {
            ...
            return redirect()->to(base_url('lainnya/manage'))->with('error', 'Gagal menghapus data reminder');
        }
    }
    ...
    public function getEvents()
    {
        ...
        $jadwalLainnyas = $model->findAll();

        return view('templates/header')
            . view('lainnya/index', ['jadwalLainnyas' => $jadwalLainnyas])
            . view('templates/footer');
    }

    public function maintenance(string $page = 'Lainnya | Maintenance')
    {
        $data['title'] = ucfirst($page);
